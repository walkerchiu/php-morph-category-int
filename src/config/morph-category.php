...
return [
    ...
    */
    'command' => [
        'cleaner' => 'WalkerChiu\MorphCategory\Console\Commands\MorphCategoryCleaner'
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Categories with the following specified identifiers cannot be deleted.
    |
    */
    'categories_protected' => [
    ],
