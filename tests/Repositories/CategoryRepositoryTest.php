...
class CategoryRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    /**
     * A basic functional test on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testMorphCategoryRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphCategory\Models\Repositories\MorphCategoryRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(CategoryLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphCategory\Models\Repositories\MorphCategoryRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        factory(Category::class)->create(['is_enabled' => 1]);
    ...
    /**
     * Unit test about Query List on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphCategory\Models\Repositories\MorphCategoryRepository
     *
    ...
    /**
     * Unit test about FormTrait on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphCategory\Models\Repositories\MorphCategoryRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Category::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(Category::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(Category::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(Category::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 1]);
            // When
    ...
    /**
     * Unit test about Auto Complete on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphCategory\Models\Repositories\MorphCategoryRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Category::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(Category::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Category::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Category::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
    ...
    /**
     * Unit test about List on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphCategory\Models\Repositories\MorphCategoryRepository
     *
    ...
    public function testList()
    {
        ...
        Config::set('wk-core.soft_delete', 1);
        Config::set('wk-morph-category.soft_delete', 1);
        Config::set('wk-morph-category.output_format', 'array');
        ...
        // Give
        $db_morph_1  = factory(Category::class)->create();
        $db_morph_2  = factory(Category::class)->create();
        $db_morph_3  = factory(Category::class)->create(['is_enabled' => 1]);
        $db_morph_4  = factory(Category::class)->create(['is_enabled' => 1]);
        $db_morph_5  = factory(Category::class)->create(['is_enabled' => 1]);
        $db_morph_6  = factory(Category::class)->create(['is_enabled' => 1]);
        $db_morph_7  = factory(Category::class)->create(['is_enabled' => 1]);
        $db_morph_8  = factory(Category::class)->create(['is_enabled' => 1]);
        $db_morph_9  = factory(Category::class)->create(['is_enabled' => 1]);
        $db_morph_10 = factory(Category::class)->create();

        // Give
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_3->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_3->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_3->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_3->id, 'morph_type' => Category::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_4->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hi']);
    ...
    /**
     * Unit test about ListMenu on CategoryRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphCategory\Models\Repositories\MorphCategoryRepository
     *
    ...
    public function testListMenu()
    {
        ...
        // Top menu
            // Give
            $db_morph_1 = factory(Category::class)->create(['is_enabled' => 1]);
            $db_lang_1  = factory(CategoryLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name']);
            $db_lang_2  = factory(CategoryLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name']);
            // When
            $count = $this->repository->count();
            $records = $this->repository->listMenu(null, null, 'en_us', 'zh_tw');
            // Then
        ...
        // Child menu
            // Give
            $db_morph_2 = factory(Category::class)->create(['ref_id' => $db_morph_1->id, 'is_enabled' => 1]);
            $db_lang_3  = factory(CategoryLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name']);
            $db_lang_4  = factory(CategoryLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Category::class, 'code' => 'en_us', 'key' => 'name']);
